...
import { createShopItems, retrieveShopItems, updateShopItem, deleteShopItem, retrieveShopItem } from './controllers/shop_item.controller'
...
export default function ShopItemRouter(app: Application): void {
  ...
  app.get(`${baseUrl}/:id`, [validToken, validShopTokenAffiliation, validShopItemOwnership, retrieveShopItem])
