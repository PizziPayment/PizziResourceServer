...
export async function validUserTokenAffiliation(req: Request<unknown, unknown, void, unknown>, res: Response, next: NextFunction): Promise<void> {
  validTokenAffiliation(req, res, next, 'user_id', 'user')
}

export async function validShopTokenAffiliation(req: Request<unknown, unknown, void, unknown>, res: Response, next: NextFunction): Promise<void> {
  validTokenAffiliation(req, res, next, 'shop_id', 'shop')
}

export async function validAdminTokenAffiliation(req: Request<unknown, unknown, void, unknown>, res: Response, next: NextFunction): Promise<void> {
